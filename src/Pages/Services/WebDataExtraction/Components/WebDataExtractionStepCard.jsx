import WebDataExtractionStepListItem from "./WebDataExtractionStepListItem";

export default function WebDataExtractionStepCard({ number, title, items, delay }) {
  return (
    <div
      ...
      <div className="relative space-y-4">
        ...
        <ul className="space-y-3">
          {items.map((item, index) => (
            <WebDataExtractionStepListItem key={index} text={item} />
          ))}
        </ul>
      </div>
    </div>
