import AnnotationStepListItem from "./AnnotationStepListItem";

export default function AnnotationStepCard({ number, title, items, delay }) {
  return (
    <div
      ...
      <div className="relative space-y-4">
        ...
        <ul className="space-y-3">
          {items.map((item, index) => (
            <AnnotationStepListItem key={index} text={item} />
          ))}
        </ul>
      </div>
    </div>
