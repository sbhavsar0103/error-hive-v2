import MachineLearningStepListItem from "./MachineLearningStepListItem";

export default function MachineLearningStepCard({ number, title, items, delay }) {
  return (
    <div
      ...
      <div className="relative space-y-4">
        ...
        <ul className="space-y-3">
          {items.map((item, index) => (
            <MachineLearningStepListItem key={index} text={item} />
          ))}
        </ul>
      </div>
    </div>
