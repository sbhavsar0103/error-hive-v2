import MobileAppScrapingStepListItem from "./MobileAppScrapingStepListItem";

export default function MobileAppScrapingStepCard({ number, title, items, delay }) {
  return (
    <div
      ...
      <div className="relative space-y-4">
        ...
        <ul className="space-y-3">
          {items.map((item, index) => (
            <MobileAppScrapingStepListItem key={index} text={item} />
          ))}
        </ul>
      </div>
    </div>
